...
class affiliationnetwork(object):
    ...
    def community_detection(self):
        ...
        PickleUtils.saver(coms, '../data/network/affiliation_community.pkl')

    def writer(self):
        network_metrics = self.network_metrics()
        coms = PickleUtils.loader('../data/network/affiliation_community.pkl')
        G = nx.read_gpickle(self.affiliation_network_gpickle)
        com_eval_df = community_evaluation_metrics(coms, G)

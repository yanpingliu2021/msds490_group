...
top_docs.head()
top_docs_cols = top_docs[['lst_nm','frst_nm','pri_spec','overall_mips_score']]
...
app.layout = html.Div([
    ...
    html.Div([cyto.Cytoscape(
        ...
        columns=[{"name": i, "id": i} 
                 for i in top_docs_cols.columns],
        data=top_docs.to_dict('records'),
...
def display_top_docs(hoverData):
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8559)#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Created on Sun May 23 16:09:30 2021
